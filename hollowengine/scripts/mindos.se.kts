...
md.stopLookAlways()
md lookAlwaysAt{pos(201, 71, 52)}

wait{5.sec}
player send {"§4Задание обновлено. Добудьте и принесите Миндосу:"}
player send {"§4- Гаечный ключ"}
player send {"§4- 5 изумрудов"}
wait{3.sec}
player send {"§6Нажмите на B, чтобы открыть меню прокачки. "}